package org.cataclysm.game.events.raids.bosses.calamity_hydra.attacks;
...
public class CalamityCharge {
    ...
    public CalamityCharge(CalamityHydra hydra, float radius, int amplifier, double scale) {
        this.hydra = hydra;
        this.radius = radius;
