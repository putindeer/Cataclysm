...
public class AtomicBreathPantheonAbility extends PantheonHydraAbility {
    private final PantheonHydra hydra;

    public AtomicBreathPantheonAbility(PantheonHydra hydra) {
        super(Material.BLAZE_POWDER, "Atomic Breath", 3, 200);
        this.hydra = hydra;
    }
    ...
    public void cast() {
        ...
        double power = 6;
        for (int i = 0; i < 8; i++) {
            this.hydra.getPantheon().getExecutor().schedule(() -> {
