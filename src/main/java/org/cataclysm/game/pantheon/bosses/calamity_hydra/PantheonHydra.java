...
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.HellquakeAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.HydraBreathAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.HydrazerAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.rage.AtomicBreathAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.rage.CalamityAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.abilities.rage.MeteorShowerAbility;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.attacks.CalamityExplosion;
import org.cataclysm.game.pantheon.bosses.calamity_hydra.rage.HydraRage;
import org.cataclysm.game.pantheon.level.levels.PantheonZones;
import org.cataclysm.game.raids.structures.RaidStructures;

public class PantheonHydra extends CataclysmBoss {
    public HydraPhase phase;
    public HydraRage rage;
    public int heads;

    public PantheonHydra() {
        super("Calamity Hydra", 6000);
        super.arena = PantheonZones.HYDRA_DUNGEON.getArena();
