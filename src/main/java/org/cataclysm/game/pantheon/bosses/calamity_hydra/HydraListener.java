...
import org.cataclysm.game.pantheon.bosses.calamity_hydra.rage.HydraRageManager;
...
public class HydraListener implements Listener {
    ...
    public void onAttack(EntityDamageByEntityEvent event) {
        ...
        if (!(boss instanceof PantheonHydra hydra) || !(damager instanceof Player player) || !CataclysmBoss.isController(player)) return;
    ...
    private void onEntityDamage(EntityDamageEvent event) {
        ...
        if (!(bossFight instanceof PantheonHydra hydra)) return;
