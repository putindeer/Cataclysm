...
public enum CataclysmItems {
    ...
    PALE_HELMET(new CataclysmItem(Material.NETHERITE_HELMET, ItemFamily.PALE_ARMOR).setDisplay("Pale Helmet").setDescription("Ex essentia silvae nullius confectum").setPassive("Aeternitas", "Al portar el set completo Pale otorga los efectos de la Calamity Armor, corazones adicionales e inmunidad a Pale Corrosion y Mortem").setAttributeLore(Attribute.ARMOR, 4, EquipmentSlotGroup.HEAD).setAttributeLore(Attribute.ARMOR_TOUGHNESS, 3, EquipmentSlotGroup.HEAD).setAttributeLore(Attribute.KNOCKBACK_RESISTANCE, 0.1, EquipmentSlotGroup.HEAD).setUnbreakable(true).addTrims(new ArmorTrim(TrimMaterial.IRON, TrimPattern.TIDE))),
    PALE_CHESTPLATE(new CataclysmItem(Material.NETHERITE_CHESTPLATE, ItemFamily.PALE_ARMOR).setDisplay("Pale Chestplate").setDescription("Ex essentia silvae nullius confectum").setPassive("Aeternitas", "Al portar el set completo Pale otorga los efectos de la Calamity Armor, corazones adicionales e inmunidad a Pale Corrosion y Mortem").setAttributeLore(Attribute.ARMOR, 9, EquipmentSlotGroup.CHEST).setAttributeLore(Attribute.ARMOR_TOUGHNESS, 9, EquipmentSlotGroup.CHEST).setAttributeLore(Attribute.KNOCKBACK_RESISTANCE, 0.1, EquipmentSlotGroup.CHEST).setUnbreakable(true).addTrims(new ArmorTrim(TrimMaterial.IRON, TrimPattern.TIDE))),
    PALE_LEGGINGS(new CataclysmItem(Material.NETHERITE_LEGGINGS, ItemFamily.PALE_ARMOR).setDisplay("Pale Leggings").setDescription("Ex essentia silvae nullius confectum").setPassive("Aeternitas", "Al portar el set completo Pale otorga los efectos de la Calamity Armor, corazones adicionales e inmunidad a Pale Corrosion y Mortem").setAttributeLore(Attribute.ARMOR, 7, EquipmentSlotGroup.LEGS).setAttributeLore(Attribute.ARMOR_TOUGHNESS, 9, EquipmentSlotGroup.LEGS).setAttributeLore(Attribute.KNOCKBACK_RESISTANCE, 0.1, EquipmentSlotGroup.LEGS).setUnbreakable(true).addTrims(new ArmorTrim(TrimMaterial.IRON, TrimPattern.TIDE))),
    PALE_BOOTS(new CataclysmItem(Material.NETHERITE_BOOTS, ItemFamily.PALE_ARMOR).setDisplay("Pale Boots").setDescription("Ex essentia silvae nullius confectum").setPassive("Aeternitas", "Al portar el set completo Pale otorga los efectos de la Calamity Armor, corazones adicionales e inmunidad a Pale Corrosion y Mortem").setAttributeLore(Attribute.ARMOR, 4, EquipmentSlotGroup.FEET).setAttributeLore(Attribute.ARMOR_TOUGHNESS, 9, EquipmentSlotGroup.FEET).setAttributeLore(Attribute.KNOCKBACK_RESISTANCE, 0.1, EquipmentSlotGroup.FEET).setUnbreakable(true).addTrims(new ArmorTrim(TrimMaterial.IRON, TrimPattern.TIDE))),
