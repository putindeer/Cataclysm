...
public enum CataclysmItems {
    ...
    PALE_TOKEN(new CataclysmItem(Material.PRISMARINE_CRYSTALS, CataclysmColor.PALE).setDisplay("Pale Token").setDescription("Collisio Mundorum").setGlint(true)),
    PARAGON_TOTEM(new CataclysmItem(Material.TOTEM_OF_UNDYING, CataclysmColor.PARAGON).setDisplay("Paragon Totem").setDescription("Superstes Numisma").setAbility("Postmortalis", "Se activa incluso con Mortem. No reduce la mortalidad y otorga inmunidad por 7 segundos.")),
