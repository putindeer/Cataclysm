...
public class ShulkerSculpture extends CataclysmMob {
    public ShulkerSculpture(Level level) {
        super(new ShulkerSculptureEntity(level), "Shulker Sculpture", CataclysmColor.MIRAGE, level);
    ...
    static class ShulkerSculptureEntity extends Vindicator {
        public ShulkerSculptureEntity(Level level) {
    ...
    public CataclysmMob createInstance() {
        return new ShulkerSculpture(super.getLevel());
    }
}