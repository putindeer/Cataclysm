...
public class PaleEnderman extends CataclysmMob {

    public PaleEnderman(Level level) {
        super(new CalamityEndermanEntity(level), "Pale Enderman", CataclysmColor.PALE, level);
        super.setHealth(60);
    ...
    protected CataclysmMob createInstance() {
        return new PaleEnderman(super.getLevel());
    }
